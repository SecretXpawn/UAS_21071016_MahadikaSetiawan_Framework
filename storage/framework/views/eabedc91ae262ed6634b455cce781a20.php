...
<html lang="en">
    ...
    <title>Mahadika Dika Website</title>
     ...
     <!-- start lwh nav -->
        ...
        <div class="container">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                <a class="nav-link <?php echo e(request()->segment('1') =='nilai'  ? 'active' : ''); ?>" aria-current="page" href="<?php echo e(route('nilaimahadika.index')); ?>">
...
</html><?php /**PATH C:\Users\asus\Downloads\laravel10_bootstrap53-main\resources\views/layout/main.blade.php ENDPATH**/ ?>