...
use App\Http\Controllers\NilaiMahadikaController;
...
Route::group(['middleware' => 'auth'], function (){
    ...
    Route::get('cetak_nilai', [NilaiMahadikaController::class, 'cetak_nilai'])->name('cetak_nilai');
    Route::get('nilai', [NilaiMahadikaController::class, 'index'])->name('nilaimahadika.index');
